...
// in duoapp/test/managers/plan_manager_test.dart.
...
import 'package:duoapp/database/duo_db.dart' as _i2;
...
class _FakeDuoDatabase_0 extends _i1.SmartFake implements _i2.DuoDatabase {
  _FakeDuoDatabase_0(
    Object parent,
...
class _Fake$DbPlanItemTable_6 extends _i1.SmartFake
    implements _i2.$DbPlanItemTable {
  _Fake$DbPlanItemTable_6(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
/// A class which mocks [PlanItemDao].
///
/// See the documentation for Mockito's code generation for more information.
class MockPlanItemDao extends _i1.Mock implements _i2.PlanItemDao {
  @override
  _i2.DuoDatabase get db => (super.noSuchMethod(
        Invocation.getter(#db),
        returnValue: _FakeDuoDatabase_0(
          this,
          Invocation.getter(#db),
        ),
        returnValueForMissingStub: _FakeDuoDatabase_0(
          this,
          Invocation.getter(#db),
        ),
      ) as _i2.DuoDatabase);
  ...
  @override
  _i2.DuoDatabase get attachedDatabase => (super.noSuchMethod(
  ...
  @override
  _i2.$DbPlanItemTable get dbPlanItem => (super.noSuchMethod(
        Invocation.getter(#dbPlanItem),
        returnValue: _Fake$DbPlanItemTable_6(
          this,
          Invocation.getter(#dbPlanItem),
        ),
        returnValueForMissingStub: _Fake$DbPlanItemTable_6(
          this,
          Invocation.getter(#dbPlanItem),
        ),
      ) as _i2.$DbPlanItemTable);

  @override
  _i5.Stream<List<_i2.DbPlanItemData>> watchAllPlans() => (super.noSuchMethod(
        Invocation.method(
          #watchAllPlans,
          [],
        ),
        returnValue: _i5.Stream<List<_i2.DbPlanItemData>>.empty(),
        returnValueForMissingStub: _i5.Stream<List<_i2.DbPlanItemData>>.empty(),
      ) as _i5.Stream<List<_i2.DbPlanItemData>>);

  @override
  _i5.Future<int> insertPlan(_i3.Insertable<_i2.DbPlanItemData>? item) =>
      (super.noSuchMethod(
        Invocation.method(
          #insertPlan,
          [item],
  ...
  @override
  _i5.Future<void> deletePlan(int? id) => (super.noSuchMethod(
        Invocation.method(
          #deletePlan,
          [id],
        ),
  ...
  _i3.DeleteStatement<T, D> delete<T extends _i3.Table, D>(
      ...
      (super.noSuchMethod(
        ...
        returnValueForMissingStub: _FakeDeleteStatement_12<T, D>(
          this,
          Invocation.method(
            #delete,
            [table],
  ...
  _i3.Selectable<_i3.QueryRow> customSelect(
    ...
    Set<_i3.ResultSetImplementation<dynamic, dynamic>>? readsFrom = const {},
      ...
      (super.noSuchMethod(
        ...
        returnValueForMissingStub: _FakeSelectable_13<_i3.QueryRow>(
          this,
          Invocation.method(
            #customSelect,
            [query],
